...
file_paths = [
    ...
    "WENO_HLLC_grid_610_Re_ 200.00_0.6_.dat",
    "MUSC_HLLC_grid_604_Re_ 200.00_0.6_.dat",

    "TENO_HLLC_grid_610_Re_1000.00_0.6_.dat",
    "WENO_HLLC_grid_610_Re_1000.00_0.6_.dat",
    "MUSC_HLLC_grid_604_Re_1000.00_0.6_.dat"
]

# Grid resolution and domain
grid_res = 1000
xi = np.linspace(0.64, 0.98, grid_res)
...
if __name__ == '__main__':
    ...
    fig_temp.suptitle("2D Viscous Shock Tube: Temperature Distribution at "+r"$t=0.6$", fontsize=16, y=0.97)
